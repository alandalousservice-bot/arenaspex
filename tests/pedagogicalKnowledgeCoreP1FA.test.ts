...
describe('P1F-A reviewed Domain 2 and Domain 3 semantic core', () => {
  ...
  it('keeps the existing Domain 1 releases and their approved structure', () => {
    ...
    expect(P1C_DOMAIN_ONE_GRADES_TWO_TO_FIVE_CATALOG.release.catalogHash).toBe('fnv1a32:f38b35d0');
  ...
  it('keeps production activation separate from this canonical criteria data', () => {
    ...
    expect(P1FA_DOMAIN_TWO_AND_THREE_CATALOG.criteria).toHaveLength(16);
    expect(P1FA_DOMAIN_TWO_AND_THREE_CATALOG.indicators).toHaveLength(16);
  });
});
