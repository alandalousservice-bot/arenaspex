...
export function renderLessonMemoHtml(model: LessonMemoDocument): string {
  ...
  const metadata: [string, string][] = [
    ...
    ['القسم', model.header.className],
    ['التاريخ', formatMemoDate(model.header.date)],
