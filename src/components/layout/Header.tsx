      ...
      <header className="app-shell-header sticky top-0 z-30 bg-white/95 backdrop-blur-md border-b border-slate-200 shadow-xs px-3 sm:px-4 lg:px-6 py-2.5 flex items-center justify-between transition-all">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-xs text-slate-500 font-medium">
                التربية البدنية والرياضية - الطور الابتدائي
              </p>
            </div>
          </div>
        ...
        >
          ...
          {showSearchResults && searchVal.trim() && (
            <div
              className="absolute top-full mt-1.5 right-0 w-full bg-white rounded-2xl border border-slate-200 shadow-xl z-40 overflow-hidden max-h-80 overflow-y-auto"
              dir="rtl"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          {activeLessonSession &&
            (activeLessonSession.status === 'in_progress' ||
              activeLessonSession.status === 'paused') &&
            onOpenCommandCenter && (
              <button
