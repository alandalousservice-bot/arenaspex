      ...
      if (userRole === 'teacher') {
        return {
          ...
          items: [
            ...
            { id: 'gradebook' as NavTab, label: 'دفتر التنقيط الذكي', icon: GraduationCap },
            { id: 'assessment_notebook' as NavTab, label: 'دفتر تقويم الكفاءات', icon: Target },
            { id: 'attendance' as NavTab, label: 'دفتر الغياب والمواظبة', icon: UserCheck },
            { id: 'students' as NavTab, label: 'دفتر التلاميذ', icon: Users },
          ],
        };
      }
        ...
        >
          <div className="p-3 space-y-6 overflow-y-auto max-h-[calc(100vh-60px)]">
            ...
            <div className="pt-2 border-t border-slate-100 space-y-1">
              ...
              {!collapsed && userRole === 'admin' && (
                <div className="px-2 mb-1 text-[11px] font-extrabold text-slate-400">
                  المتابعة والتحليل
                </div>
              )}
          ...
          {userRole === 'teacher' ? (
            ...
            <>
              <button
                ...
                className={`flex flex-col items-center gap-1 px-2 py-1 rounded-xl min-w-[56px] min-h-[44px] justify-center transition-all ${
                  currentTab === 'inspector_portal' ||
                  currentTab === 'director_portal' ||
